		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<div class="">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>List of all cleared Students</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">
								<table id="datatable-buttons" class="table table-hover table-bordered">
									...
									<tbody>
										<?php
										$sql = "SELECT * FROM faculty NATURAL JOIN clearance where is_accountant_approval and is_librarian_approval and is_registrar_approval and is_dean_approval=1";
			...
			<footer>
				<div class="pull-right">
					OC System By Angelo Owusu-Acheaw
				</div>
				<div class="clearfix"></div>
			</footer>
			<!-- /footer content -->
