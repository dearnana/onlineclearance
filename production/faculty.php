			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="#" class="site_title"><i class="fa fa-heart"></i> <span>ASKMA</span></a>
					</div>
									...
									<div class="row">
										<div class="col-md-12">
											<center>
												...
												<strong>Asokwa Municipal Assembly</strong><br />
												Asokwa, Kumasi
												<br />
												<br />
												<strong>ASKMA ATTACHMENT PERSONNELS CLEARANCE</strong>
												<br />
												<small>(Purpose: School Resumes, End of Attachment, Commutation Maternity Leave, Study Leave, Vacation/Sick Leave)</small>
											</center>
										</div>
										<div class="row">
											...
											<div class="row">
												<div class="col-md-12">
													<p>
														I have the honor to inform your good Office that I have satisfactoryily accounted for all suppervision and property accountabilities and that all reports were complied with on dates shown below :
													</p>
